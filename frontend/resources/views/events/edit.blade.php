                ...
                <div class="col-xxl">
                    <div class="card mb-4 p-6">
                        ...
                        <div class="card-body">
                            ...
                            <x-forms.textarea name="description" label="Description" placeholder="..." value="{{ $event['description'] }}"
                                desc="Tell us more about your event" />

                            <x-forms.input label="Event Poster" name="poster_url" type="file"
                                placeholder="Upload a visual poster or banner for the event. Max file size 2MB." value="{{ $event['poster_url'] }}"
                                desc="" />
